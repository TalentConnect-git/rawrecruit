...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,v,const DeepCollectionEquality().hash(_achievements),const DeepCollectionEquality().hash(_awards),const DeepCollectionEquality().hash(_publications),createdAt,updatedAt,profileImage,currentCompany,noticePeriod,const DeepCollectionEquality().hash(_domainKnowledge),const DeepCollectionEquality().hash(_employmentType),const DeepCollectionEquality().hash(_experiences),const DeepCollectionEquality().hash(_industry),const DeepCollectionEquality().hash(_internationalExperience),const DeepCollectionEquality().hash(_jobRoles),const DeepCollectionEquality().hash(_languagesKnown),const DeepCollectionEquality().hash(_leadership),const DeepCollectionEquality().hash(_locations),const DeepCollectionEquality().hash(_lookingFor),resume,const DeepCollectionEquality().hash(_skills),const DeepCollectionEquality().hash(_toolsAndPlatforms),about,certifications,cgpa,college,degree,degreeCertificate,email,emailVerified,mobile,designation,gender,github,linkedin,name,openToShift,phone,portfolio,profileType,referralSource,semester,servingNoticePeriod,specialization,yearOfGraduation,currentSalaryAmount,currentSalaryCurrency,dob,ethnicity,expectedSalaryAmount,expectedSalaryCurrency,maritalStatus,visaStatus,const DeepCollectionEquality().hash(_referralJobs)]);
