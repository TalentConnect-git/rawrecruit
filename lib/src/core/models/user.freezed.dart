...
@useResult
$Res call({
@JsonKey(name: '_id') String? id, String? userId,@JsonKey(name: '__v') int? v, String? companyEmail, List<Achievement>? achievements, List<Award>? awards, List<Publication>? publications, String? createdAt, String? updatedAt, String? profileImage, String? currentCompany,@JsonKey(name: 'totalYearsOfExperience') String? totalYearsOfExperience, String? noticePeriod, String? noticePeriodStartDate, bool? servingNoticePeriod, List<String>? domainKnowledge, List<String>? employmentType, List<Experience>? experiences, List<String>? industry,@JsonKey(name: 'leadership') List<LeadershipExperience>? leadershipExperiences,@JsonKey(name: 'internationalExperience') List<InternationalExperience>? internationalExperiences, List<Education>? educations, List<String>? jobRoles, List<String>? languagesKnown, List<String>? locations, List<String>? lookingFor, String? resume, List<String>? skills, List<String>? toolsAndPlatforms, String? about, String? certifications, String? degreeCertificate, String? email, bool? emailVerified, String? mobile, String? designation, String? gender, String? github, String? linkedin, String? name, String? openToShift, String? phone, String? portfolio, String? profileType, bool? onboardingCompleted, String? referralSource, String? currentSalaryAmount, String? currentSalaryCurrency, String? dob, String? ethnicity, String? expectedSalaryAmount, String? expectedSalaryCurrency, String? maritalStatus, String? visaStatus, List<Job>? referralJobs
});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,v,companyEmail,const DeepCollectionEquality().hash(_achievements),const DeepCollectionEquality().hash(_awards),const DeepCollectionEquality().hash(_publications),createdAt,updatedAt,profileImage,currentCompany,totalYearsOfExperience,noticePeriod,noticePeriodStartDate,servingNoticePeriod,const DeepCollectionEquality().hash(_domainKnowledge),const DeepCollectionEquality().hash(_employmentType),const DeepCollectionEquality().hash(_experiences),const DeepCollectionEquality().hash(_industry),const DeepCollectionEquality().hash(_leadershipExperiences),const DeepCollectionEquality().hash(_internationalExperiences),const DeepCollectionEquality().hash(_educations),const DeepCollectionEquality().hash(_jobRoles),const DeepCollectionEquality().hash(_languagesKnown),const DeepCollectionEquality().hash(_locations),const DeepCollectionEquality().hash(_lookingFor),resume,const DeepCollectionEquality().hash(_skills),const DeepCollectionEquality().hash(_toolsAndPlatforms),about,certifications,degreeCertificate,email,emailVerified,mobile,designation,gender,github,linkedin,name,openToShift,phone,portfolio,profileType,onboardingCompleted,referralSource,currentSalaryAmount,currentSalaryCurrency,dob,ethnicity,expectedSalaryAmount,expectedSalaryCurrency,maritalStatus,visaStatus,const DeepCollectionEquality().hash(_referralJobs)]);
