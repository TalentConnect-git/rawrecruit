...
@JsonKey(fromJson: _safeList) List<String>? get jobRoles;@JsonKey(fromJson: _safeList) List<String>? get location;@JsonKey(fromJson: _safeList) List<String>? get workMode;@JsonKey(fromJson: _safeList) List<String>? get skills;@JsonKey(fromJson: _safeList) List<String>? get benefits;@JsonKey(fromJson: _safeList) List<String>? get certifications; List<String>? get degree; List<String>? get studentStreams;// Lists - Location & Work
 ...
 PackageDetail? get packageDetails; User? get contactPerson; Timeline? get interviewWindow;@UserOrStringConvertor()@JsonKey(name: 'candidatePosted') User? get candidatePosted; JobPosting? get companyPosted; JobPosting? get jobCompanyPosted; String? get referralCompany; String? get careerPageUrl; bool? get isAskForReferral; String? get referralRequestId;// Dates
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,postedByUser,jobTitle,description,jobStatus,approvalStatus,visibleTo,broadcastType,jobType,eligibilityCriteria,companyName,status,workAuthorization,minEducation,const DeepCollectionEquality().hash(yearsOfExperience),const DeepCollectionEquality().hash(cgpa),numberOfOpenings,views,matchScore,adminComment,rating,alumniCount,const DeepCollectionEquality().hash(_jobRoles),const DeepCollectionEquality().hash(_location),const DeepCollectionEquality().hash(_workMode),const DeepCollectionEquality().hash(_skills),const DeepCollectionEquality().hash(_benefits),const DeepCollectionEquality().hash(_certifications),const DeepCollectionEquality().hash(_degree),const DeepCollectionEquality().hash(_studentStreams),const DeepCollectionEquality().hash(_employmentType),const DeepCollectionEquality().hash(_workLocation),const DeepCollectionEquality().hash(_companyType),const DeepCollectionEquality().hash(_collegeTypes),const DeepCollectionEquality().hash(_collegeCategories),const DeepCollectionEquality().hash(_rounds),const DeepCollectionEquality().hash(_selectionProcess),const DeepCollectionEquality().hash(_workAchievements),const DeepCollectionEquality().hash(_amenitiesRequired),const DeepCollectionEquality().hash(_toolsAndPlatforms),const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_numberOfStudent),venue,internshipDuration,const DeepCollectionEquality().hash(minimumStudents),packageDetails,contactPerson,interviewWindow,candidatePosted,companyPosted,jobCompanyPosted,referralCompany,careerPageUrl,isAskForReferral,referralRequestId,onlineTestDate,offerRolloutDate,startDate,endDate,expireAt,createdAt,updatedAt]);
