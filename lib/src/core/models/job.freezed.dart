...
@JsonKey(fromJson: _safeList) List<String>? get jobRoles;@JsonKey(fromJson: _safeList) List<String>? get location;@JsonKey(fromJson: _safeList) List<String>? get workMode;@JsonKey(fromJson: _safeList) List<String>? get skills;@JsonKey(fromJson: _safeList) List<String>? get benefits; List<String>? get certifications; List<String>? get degree; List<String>? get studentStreams;// Lists - Location & Work
