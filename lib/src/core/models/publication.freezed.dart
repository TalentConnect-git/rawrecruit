...
@JsonKey(name: '_id') String? get id; String? get title; String? get url;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Publication&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.url, url) || other.url == url));
}
...
@override
String toString() {
  return 'Publication(id: $id, title: $title, url: $url)';
}
...
@useResult
$Res call({
@JsonKey(name: '_id') String? id, String? title, String? url
});
...
/// Create a copy of Publication
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = freezed,Object? url = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String? id,  String? title,  String? url)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Publication() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String? id,  String? title,  String? url)  $default,) {final _that = this;
switch (_that) {
case _Publication():
return $default(_that.id,_that.title,_that.url);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: '_id')  String? id,  String? title,  String? url)?  $default,) {final _that = this;
switch (_that) {
case _Publication() when $default != null:
return $default(_that.id,_that.title,_that.url);case _:
  return null;
...
class _Publication implements Publication {
   _Publication({@JsonKey(name: '_id') this.id, this.title, this.url});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Publication&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.url, url) || other.url == url));
}
...
/// Create a copy of Publication
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? title = freezed,Object? url = freezed,}) {
