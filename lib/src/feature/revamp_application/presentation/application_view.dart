...
import 'package:rawrecruit/src/feature/revamp_application/presentation/widget/search_bar.dart';

class ApplicationsView extends StatefulWidget {
  const ApplicationsView({super.key});

  @override
  State<ApplicationsView> createState() =>
      _ApplicationsViewState();
}

class _ApplicationsViewState
    extends State<ApplicationsView> {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: vm.appliedApplications.isEmpty
                          ...
                          : ListView.builder(
                              itemCount:
                                  vm.appliedApplications.length,
                              itemBuilder:
                                  (context, index) {

                                final item =
                                    vm.appliedApplications[index];
