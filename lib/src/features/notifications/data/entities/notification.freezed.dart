...
@JsonKey(name: '_id') String? get id; String? get recipientId; String? get senderId; NotificationType? get type; String? get message; String? get referenceId; String? get fileUrl; String? get fileName; String? get eventTitle; String? get meetingLink; JobType? get jobType; bool? get read; String? get jobId; Map<String, dynamic>? get meta; DateTime? get createdAt; DateTime? get updatedAt;
...
@useResult
$Res call({
@JsonKey(name: '_id') String? id, String? recipientId, String? senderId, NotificationType? type, String? message, String? referenceId, String? fileUrl, String? fileName, String? eventTitle, String? meetingLink, JobType? jobType, bool? read, String? jobId, Map<String, dynamic>? meta, DateTime? createdAt, DateTime? updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String? id,  String? recipientId,  String? senderId,  NotificationType? type,  String? message,  String? referenceId,  String? fileUrl,  String? fileName,  String? eventTitle,  String? meetingLink,  JobType? jobType,  bool? read,  String? jobId,  Map<String, dynamic>? meta,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Notification() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String? id,  String? recipientId,  String? senderId,  NotificationType? type,  String? message,  String? referenceId,  String? fileUrl,  String? fileName,  String? eventTitle,  String? meetingLink,  JobType? jobType,  bool? read,  String? jobId,  Map<String, dynamic>? meta,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Notification():
return $default(_that.id,_that.recipientId,_that.senderId,_that.type,_that.message,_that.referenceId,_that.fileUrl,_that.fileName,_that.eventTitle,_that.meetingLink,_that.jobType,_that.read,_that.jobId,_that.meta,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: '_id')  String? id,  String? recipientId,  String? senderId,  NotificationType? type,  String? message,  String? referenceId,  String? fileUrl,  String? fileName,  String? eventTitle,  String? meetingLink,  JobType? jobType,  bool? read,  String? jobId,  Map<String, dynamic>? meta,  DateTime? createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Notification() when $default != null:
return $default(_that.id,_that.recipientId,_that.senderId,_that.type,_that.message,_that.referenceId,_that.fileUrl,_that.fileName,_that.eventTitle,_that.meetingLink,_that.jobType,_that.read,_that.jobId,_that.meta,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Notification implements Notification {
  const _Notification({@JsonKey(name: '_id') this.id, this.recipientId, this.senderId, this.type, this.message, this.referenceId, this.fileUrl, this.fileName, this.eventTitle, this.meetingLink, this.jobType, this.read = false, this.jobId, final  Map<String, dynamic>? meta, this.createdAt, this.updatedAt}): _meta = meta;
