...
import 'package:rawrecruit/src/features/dashboard/presentation/widgets/dashboard_card.dart';
      ...
      builder: (context, vm, _) {
        ...
        return RefreshIndicator(
          ...
          onRefresh: () async {
            ...
            await context.read<MyProfileViewModel>().getCandidateStats();

            await context.read<MyProfileViewModel>().getCareerInsights();
          },
