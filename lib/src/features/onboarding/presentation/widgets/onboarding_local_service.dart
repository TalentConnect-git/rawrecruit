...
class OnboardingLocalService {
  ...
  static const String onboardingUserKey = 'onboarding_user';
  ...
  Future<void> saveStep(int step) async {
    ...
    await prefs.setInt(onboardingStepKey, step);
  }
  ...
  Future<void> saveUser(User user) async {
    ...
    await prefs.setString(onboardingUserKey, jsonEncode(user.toJson()));
  }
  ...
  Future<User?> getUser() async {
    ...
    final data = prefs.getString(onboardingUserKey);
