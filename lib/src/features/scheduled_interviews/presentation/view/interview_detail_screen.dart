...
class InterviewDetailScreen extends StatefulWidget {
  ...
  @override
  State<InterviewDetailScreen> createState() =>
                ...
                children: [
                  ...
                  _InfoSection(
                    ...
                    children: [
                      ...
                      if (interview.companySnapshot?.scheduledBy?.name
                              ?.isNotEmpty ==
                          true) ...[
                        _InfoTile(
                          ...
                          label: 'Scheduled By',
                          value: interview
                              .companySnapshot!.scheduledBy!.name!,
                        ),
                        _InfoTile(
                          icon: Icons.work_outline,
                          label: 'Designation',
                          value: interview.companySnapshot?.scheduledBy
                                  ?.designation ??
                              '—',
                        ),
                        _InfoTile(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    color:
                        isLink ? AppColors.kGreen : Colors.white,
                    decoration:
