...
@JsonKey(name: '_id') String? get id; List<String>? get jobTitle; String? get description; String? get approvalStatus; List<String>? get employmentType; List<String>? get workMode; String? get broadcastType; String? get jobType; List<String>? get location; String? get minEducation; int? get numberOfOpenings; PackageDetails? get packageDetails; List<String>? get skills; String? get companyName; List<String>? get studentStreams; List<String>? get tags; String? get workAuthorization; String? get yearsOfExperience; String? get minYearofExperience; List<String>? get rounds; User? get senderProfile; List<String>? get selectionProcess; bool? get isAskForReferral; String? get endDate; bool? get inactive; List<String>? get benefits; List<String>? get certifications; String? get eligibilityCriteria; Metrics? get metrics;
...
@useResult
$Res call({
@JsonKey(name: '_id') String? id, List<String>? jobTitle, String? description, String? approvalStatus, List<String>? employmentType, List<String>? workMode, String? broadcastType, String? jobType, List<String>? location, String? minEducation, int? numberOfOpenings, PackageDetails? packageDetails, List<String>? skills, String? companyName, List<String>? studentStreams, List<String>? tags, String? workAuthorization, String? yearsOfExperience, String? minYearofExperience, List<String>? rounds, User? senderProfile, List<String>? selectionProcess, bool? isAskForReferral, String? endDate, bool? inactive, List<String>? benefits, List<String>? certifications, String? eligibilityCriteria, Metrics? metrics
});
...
as List<String>?,companyName: freezed == companyName ? _self.companyName : companyName // ignore: cast_nullable_to_non_nullable
as String?,studentStreams: freezed == studentStreams ? _self.studentStreams : studentStreams // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String? id,  List<String>? jobTitle,  String? description,  String? approvalStatus,  List<String>? employmentType,  List<String>? workMode,  String? broadcastType,  String? jobType,  List<String>? location,  String? minEducation,  int? numberOfOpenings,  PackageDetails? packageDetails,  List<String>? skills,  String? companyName,  List<String>? studentStreams,  List<String>? tags,  String? workAuthorization,  String? yearsOfExperience,  String? minYearofExperience,  List<String>? rounds,  User? senderProfile,  List<String>? selectionProcess,  bool? isAskForReferral,  String? endDate,  bool? inactive,  List<String>? benefits,  List<String>? certifications,  String? eligibilityCriteria,  Metrics? metrics)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReferralPostModel() when $default != null:
return $default(_that.id,_that.jobTitle,_that.description,_that.approvalStatus,_that.employmentType,_that.workMode,_that.broadcastType,_that.jobType,_that.location,_that.minEducation,_that.numberOfOpenings,_that.packageDetails,_that.skills,_that.companyName,_that.studentStreams,_that.tags,_that.workAuthorization,_that.yearsOfExperience,_that.minYearofExperience,_that.rounds,_that.senderProfile,_that.selectionProcess,_that.isAskForReferral,_that.endDate,_that.inactive,_that.benefits,_that.certifications,_that.eligibilityCriteria,_that.metrics);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String? id,  List<String>? jobTitle,  String? description,  String? approvalStatus,  List<String>? employmentType,  List<String>? workMode,  String? broadcastType,  String? jobType,  List<String>? location,  String? minEducation,  int? numberOfOpenings,  PackageDetails? packageDetails,  List<String>? skills,  String? companyName,  List<String>? studentStreams,  List<String>? tags,  String? workAuthorization,  String? yearsOfExperience,  String? minYearofExperience,  List<String>? rounds,  User? senderProfile,  List<String>? selectionProcess,  bool? isAskForReferral,  String? endDate,  bool? inactive,  List<String>? benefits,  List<String>? certifications,  String? eligibilityCriteria,  Metrics? metrics)  $default,) {final _that = this;
switch (_that) {
case _ReferralPostModel():
return $default(_that.id,_that.jobTitle,_that.description,_that.approvalStatus,_that.employmentType,_that.workMode,_that.broadcastType,_that.jobType,_that.location,_that.minEducation,_that.numberOfOpenings,_that.packageDetails,_that.skills,_that.companyName,_that.studentStreams,_that.tags,_that.workAuthorization,_that.yearsOfExperience,_that.minYearofExperience,_that.rounds,_that.senderProfile,_that.selectionProcess,_that.isAskForReferral,_that.endDate,_that.inactive,_that.benefits,_that.certifications,_that.eligibilityCriteria,_that.metrics);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: '_id')  String? id,  List<String>? jobTitle,  String? description,  String? approvalStatus,  List<String>? employmentType,  List<String>? workMode,  String? broadcastType,  String? jobType,  List<String>? location,  String? minEducation,  int? numberOfOpenings,  PackageDetails? packageDetails,  List<String>? skills,  String? companyName,  List<String>? studentStreams,  List<String>? tags,  String? workAuthorization,  String? yearsOfExperience,  String? minYearofExperience,  List<String>? rounds,  User? senderProfile,  List<String>? selectionProcess,  bool? isAskForReferral,  String? endDate,  bool? inactive,  List<String>? benefits,  List<String>? certifications,  String? eligibilityCriteria,  Metrics? metrics)?  $default,) {final _that = this;
switch (_that) {
case _ReferralPostModel() when $default != null:
return $default(_that.id,_that.jobTitle,_that.description,_that.approvalStatus,_that.employmentType,_that.workMode,_that.broadcastType,_that.jobType,_that.location,_that.minEducation,_that.numberOfOpenings,_that.packageDetails,_that.skills,_that.companyName,_that.studentStreams,_that.tags,_that.workAuthorization,_that.yearsOfExperience,_that.minYearofExperience,_that.rounds,_that.senderProfile,_that.selectionProcess,_that.isAskForReferral,_that.endDate,_that.inactive,_that.benefits,_that.certifications,_that.eligibilityCriteria,_that.metrics);case _:
  return null;
...
as List<String>?,companyName: freezed == companyName ? _self.companyName : companyName // ignore: cast_nullable_to_non_nullable
as String?,studentStreams: freezed == studentStreams ? _self._studentStreams : studentStreams // ignore: cast_nullable_to_non_nullable
