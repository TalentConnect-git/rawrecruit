...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,applicant,applicantType,adminApprovalStatus,job,currentStatus,createdAt);

@override
String toString() {
  return 'ReferralApplication(id: $id, applicant: $applicant, applicantType: $applicantType, adminApprovalStatus: $adminApprovalStatus, job: $job, currentStatus: $currentStatus, createdAt: $createdAt)';
}
...
/// Create a copy of ReferralApplication
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? applicant = freezed,Object? applicantType = freezed,Object? adminApprovalStatus = freezed,Object? job = freezed,Object? currentStatus = freezed,Object? createdAt = freezed,}) {
...
class _ReferralApplication implements ReferralApplication {
  const _ReferralApplication({@JsonKey(name: '_id') this.id, this.applicant, this.applicantType, this.adminApprovalStatus, this.job, @ApplicationStatusConvertor() this.currentStatus, this.createdAt});
...
/// Create a copy of ReferralApplication
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? applicant = freezed,Object? applicantType = freezed,Object? adminApprovalStatus = freezed,Object? job = freezed,Object? currentStatus = freezed,Object? createdAt = freezed,}) {
