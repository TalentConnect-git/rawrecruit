...
as PackageDetails?,metrics: freezed == metrics ? _self.metrics : metrics // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$ReferralMetricsCopyWith<$Res>? get metrics {
    if (_self.metrics == null) {
    return null;
  }

  return $ReferralMetricsCopyWith<$Res>(_self.metrics!, (value) {
...
@override $CandidatePostedCopyWith<$Res>? get candidatePosted;@override $PackageDetailsCopyWith<$Res>? get packageDetails;@override $ReferralMetricsCopyWith<$Res>? get metrics;
