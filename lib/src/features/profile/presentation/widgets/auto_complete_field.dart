...
class CommonAutocomplete extends StatelessWidget {
  ...
  /// 🔥 IMPORTANT FIX
  if (filtered.isEmpty) {
    return ['__create__']; // dummy item to force dropdown
  }

  return filtered;
},
          onSelected: (value) {
            currentText = value; // ✅ keep sync
          ...
          fieldViewBuilder: (
            ...
            /// 🔥 IMPORTANT FIX: don't overwrite typing
            ...
            return TextField(
              ...
              onChanged: (val) {
                currentText = val; // ✅ track live typing
                onChanged(val);
              },
              onSubmitted: (val) {
                currentText = val;
